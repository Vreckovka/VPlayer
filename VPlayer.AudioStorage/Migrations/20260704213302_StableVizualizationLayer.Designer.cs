...
namespace VPlayer.AudioStorage.Migrations
{
    ...
    [Migration("20260704213302_StableVizualizationLayer")]
    partial class StableVizualizationLayer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.FileInfoEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.PinnedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.SoundItem", b =>
                {
                    ...
                    b.Property<int?>("FileInfoEntityId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.SoundItem", b =>
                {
                    b.HasOne("VPlayer.AudioStorage.DomainClasses.FileInfoEntity", "FileInfoEntity")
                        .WithMany()
                        .HasForeignKey("FileInfoEntityId");

                    b.Navigation("FileInfoEntity");
                });
