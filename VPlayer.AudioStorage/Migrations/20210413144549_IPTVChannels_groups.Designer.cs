...
namespace VPlayer.AudioStorage.Migrations
{
    ...
    [Migration("20210413144549_IPTVChannels_groups")]
    partial class IPTVChannels_groups
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.IPTV.TVChannel", b =>
                {
                    ...
                    b.Property<int?>("TVChannelGroupsId")
                        .HasColumnType("INTEGER");

                    b.Property<string>("UniqueIndetifier")
                        .HasColumnType("TEXT");

                    b.HasKey("Id");

                    b.HasIndex("TVChannelGroupsId");

                    b.ToTable("TVChannels");
                });

            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.IPTV.TVChannelGroups", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.IPTV.TVChannel", b =>
                {
                    b.HasOne("VPlayer.AudioStorage.DomainClasses.IPTV.TVChannelGroups", null)
                        .WithMany("TVChannels")
                        .HasForeignKey("TVChannelGroupsId");
                });

            modelBuilder.Entity("VPlayer.AudioStorage.DomainClasses.IPTV.TVChannelGroups", b =>
                {
                    b.HasOne("VPlayer.AudioStorage.DomainClasses.IPTV.TVSource", null)
                        .WithMany("TVChannelsGroups")
